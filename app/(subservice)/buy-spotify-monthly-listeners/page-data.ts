...
export const data: SpotifyMonthlyListenersPageData = {
  ...
  whyChoose: {
    ...
    subtitle:
      'TrendEvo is built for Bangladeshi artists, musicians, labels, agencies, and creators who want a simple way to improve Spotify listener growth. From local payment options to easy order tracking, every part of the platform helps music professionals manage Spotify audience development with more confidence.',
    titleClassName:
