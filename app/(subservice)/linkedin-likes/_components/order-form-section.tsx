...
const TITLE_LINKEDIN_ICON_SIZE = 29;
const FORM_LINKEDIN_ICON_SIZE = 20;
...
function LinkedinIcon({
  ...
  const size = variant === 'title' ? TITLE_LINKEDIN_ICON_SIZE : FORM_LINKEDIN_ICON_SIZE;
...
export default function LinkedinLikesOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://linkedin.com/posts/username_activity-123456789');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <LinkedinIcon variant="title" alt="LinkedIn" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="LinkedIn Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
                    onChange={(event) => setTargetUrl(event.target.value)}
                    placeholder="https://linkedin.com/posts/username_activity-123456789"
