...
import SnapchatFollowersCtaSection from '@/app/(subservice)/buy-snapchat-followers/_components/cta-section';
import SnapchatFollowersHeroSection from '@/app/(subservice)/buy-snapchat-followers/_components/hero-section';
import SnapchatFollowersOrderFormSection from '@/app/(subservice)/buy-snapchat-followers/_components/order-form-section';
import SnapchatFollowersWorkingProcessSection from '@/app/(subservice)/buy-snapchat-followers/_components/working-process-section';
