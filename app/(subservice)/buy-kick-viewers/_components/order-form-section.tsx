...
const TITLE_KICK_ICON_SIZE = 29;
const FORM_KICK_ICON_SIZE = 20;
...
function KickIcon({
  ...
  const size = variant === 'title' ? TITLE_KICK_ICON_SIZE : FORM_KICK_ICON_SIZE;
...
export default function KickViewersOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://kick.com/yourchannel');
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <KickIcon variant="title" alt="Kick" />
                  </span>
