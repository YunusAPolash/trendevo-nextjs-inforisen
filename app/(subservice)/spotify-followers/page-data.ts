...
type SpotifyFollowersPageData = {
  ...
  serviceLeadingSlugs: ['spotify-followers', 'spotify-followers-related-services'];
...
export const data: SpotifyFollowersPageData = {
  seo: {
    title: 'Buy Spotify Followers | TrendEvo',
    description:
      'Buy real Spotify followers at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/spotify-followers',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Spotify Followers> in Real, Fast & Affordable price.',
    description:
      'Growing a Spotify artist profile can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your music thrive with real followers and artist growth.',
    signInLabel: 'Sign In',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Spotify Followers gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Spotify Followers Service',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Spotify followers, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Spotify followers can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Spotify password — only your public artist URL is required to deliver followers.',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver followers gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your artist profile.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Spotify followers delivery progresses.',
      },
      {
