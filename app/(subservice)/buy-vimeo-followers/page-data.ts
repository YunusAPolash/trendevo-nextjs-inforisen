...
type VimeoFollowersPageData = {
  ...
  serviceLeadingSlugs: ['vimeo-followers', 'vimeo-followers-related-services'];
...
export const data: VimeoFollowersPageData = {
  seo: {
    title: 'Buy Vimeo Followers | TrendEvo',
    description:
      'Buy real Vimeo followers at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/buy-vimeo-followers',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Vimeo Followers> in Real, Fast & Affordable price.',
    description:
      'Growing a Vimeo channel can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your channel thrive with real followers and engagement.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      src: '/images/subservice/buy-vimeo-followers/buy-vimeo-followers-in-real-fast-and-affordable-price.webp',
      alt: 'Excited user celebrating Vimeo growth with analytics chart',
      width: 558,
      height: 621,
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Vimeo Followers gt<on TrendEvo>',
    subtitle:
      'A Vimeo SMM panel helps businesses grow followers, likes, and engagement quickly and efficiently, saving time and boosting online presence.',
    titleClassName:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Vimeo Followers Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your Vimeo Channel URL & Place the Order',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Vimeo followers, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Vimeo followers can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Vimeo password — only your public channel URL is required to deliver followers',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Vimeo followers delivery progresses.',
      },
      {
