...
type DiscordAccountPageData = {
  ...
  serviceLeadingSlugs: ['discord-account', 'discord-account-related-services'];
...
export const data: DiscordAccountPageData = {
  seo: {
    title: 'Buy Discord Account | TrendEvo',
    description:
      'Buy real Discord accounts at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/buy-discord-account',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Discord Account> in Real, Fast & Affordable price.',
    description:
      'Getting started on Discord can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help you get quality Discord accounts quickly and securely.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      src: '/images/subservice/buy-discord-account/buy-discord-account-in-real-fast-and-affordable-price.webp',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Discord Account gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Discord Account Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your Discord Username & Place the Order',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Discord accounts, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Discord accounts can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Discord password — only your order details is required to deliver accounts',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver accounts gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your account.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Discord accounts delivery progresses.',
      },
      {
