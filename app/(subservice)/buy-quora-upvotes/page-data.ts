...
type QuoraUpvotesPageData = {
  ...
  serviceLeadingSlugs: ['quora-upvotes', 'quora-upvotes-related-services'];
...
export const data: QuoraUpvotesPageData = {
  seo: {
    title: 'Buy Quora Upvotes | TrendEvo',
    description:
      'Buy real Quora upvotes at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/buy-quora-upvotes',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Quora Upvotes> in Real, Fast & Affordable price.',
    description:
      'Growing on Quora can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your answers thrive with real upvotes and visibility.',
    signInLabel: 'Sign In',
  ...
  workingProcess: {
    ...
    subtitle:
      'A Quora SMM panel helps businesses grow followers, likes, and engagement quickly and efficiently, saving time and boosting online presence.',
    titleClassName:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Quora Upvotes Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your Quora Answer URL & Place the Order',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Quora upvotes, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Quora upvotes can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Quora password — only your public answer URL is required to deliver upvotes',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver upvotes gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your profile.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Quora upvotes delivery progresses.',
      },
      {
