...
type InstagramLikesPageData = {
  ...
  serviceLeadingSlugs: ['instagram-likes', 'instagram-likes-related-services'];
...
export const data: InstagramLikesPageData = {
  seo: {
    title: 'Buy Instagram Likes | TrendEvo',
    description:
      'Buy real Instagram likes at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/instagram-likes',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Instagram Likes> in Real, Fast & Affordable price.',
    description:
      'Growing an Instagram profile can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your profile thrive with real likes and engagement.',
    signInLabel: 'Sign In',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Instagram Likes gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Instagram Likes Service',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Instagram likes, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Instagram likes can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Instagram password — only your public post URL is required to deliver likes.',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver likes gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your account.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Instagram likes delivery progresses.',
      },
      {
