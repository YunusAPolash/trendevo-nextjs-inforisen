...
const TITLE_TWITTER_ICON_SIZE = 29;
const FORM_TWITTER_ICON_SIZE = 20;
...
function TwitterIcon({
  ...
  const size = variant === 'title' ? TITLE_TWITTER_ICON_SIZE : FORM_TWITTER_ICON_SIZE;
...
export default function TwitterLikesOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://x.com/username/status/123456789');
