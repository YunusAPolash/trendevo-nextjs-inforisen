...
type TiktokViewsPageData = {
  ...
  serviceLeadingSlugs: ['tiktok-views', 'tiktok-views-related-services'];
...
export const data: TiktokViewsPageData = {
  seo: {
    title: 'Buy TikTok Views | TrendEvo',
    description:
      'Buy real TikTok views at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/tiktok-views',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<TikTok Views> in Real, Fast & Affordable price.',
    description:
      'Growing a TikTok profile can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your profile thrive with real views and watch-time growth.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      ...
      alt: 'Excited user celebrating TikTok profile growth with analytics chart',
      width: 558,
      height: 621,
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy TikTok Views gt<on TrendEvo>',
    subtitle:
      'A TikTok SMM panel helps businesses grow followers, likes, and engagement quickly and efficiently, saving time and boosting online presence.',
    titleClassName:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the TikTok Views Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your TikTok Video URL & Place the Order',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as TikTok views, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your TikTok views can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your TikTok password — only your public video URL is required to deliver views.',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver views gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your profile.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your TikTok views delivery progresses.',
      },
      {
