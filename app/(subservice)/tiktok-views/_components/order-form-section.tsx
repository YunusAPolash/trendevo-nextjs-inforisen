...
const TIKTOK_ICON =
  '/images/icons/pricing-tiktok-platform-icon.webp';
const TITLE_TIKTOK_ICON_SIZE = 29;
const FORM_TIKTOK_ICON_SIZE = 20;
...
function TiktokIcon({
  ...
  const size = variant === 'title' ? TITLE_TIKTOK_ICON_SIZE : FORM_TIKTOK_ICON_SIZE;
...
export default function TiktokViewsOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://tiktok.com/@username/video/123456789');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <TiktokIcon variant="title" alt="TikTok" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="TikTok Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
