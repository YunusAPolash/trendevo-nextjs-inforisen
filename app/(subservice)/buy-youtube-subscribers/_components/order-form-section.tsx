...
const YOUTUBE_ICON =
  '/images/pricing/youtube-platform-icon.webp';
const TITLE_YOUTUBE_ICON_SIZE = 29;
const FORM_YOUTUBE_ICON_SIZE = 20;
...
function YoutubeIcon({
  ...
  const size = variant === 'title' ? TITLE_YOUTUBE_ICON_SIZE : FORM_YOUTUBE_ICON_SIZE;
      ...
      >
        ...
        >
          ...
          <input
            ...
            aria-label="Subscriber quantity"
...
export default function YoutubeSubscribersOrderFormSection() {
  const [channelUrl, setChannelUrl] = useState(orderForm.urlPlaceholder);
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <YoutubeIcon variant="title" alt="YouTube" />
                  </span>
