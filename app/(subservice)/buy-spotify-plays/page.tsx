...
import SpotifyPlaysCtaSection from '@/app/(subservice)/buy-spotify-plays/_components/cta-section';
import SpotifyPlaysHeroSection from '@/app/(subservice)/buy-spotify-plays/_components/hero-section';
import SpotifyPlaysOrderFormSection from '@/app/(subservice)/buy-spotify-plays/_components/order-form-section';
import SpotifyPlaysWorkingProcessSection from '@/app/(subservice)/buy-spotify-plays/_components/working-process-section';
