...
export const data: TelegramMembersPageData = {
  ...
  whyChoose: {
    ...
    subtitle:
      'lnk<TrendEvo|/about-us> is built for Bangladeshi users who want a simple and reliable way to grow Telegram groups and channels. From easy order placement to local payment support, every part of the platform helps businesses, creators, agencies, startups, and community owners manage Telegram growth with more confidence.',
    titleClassName:
  ...
  whoShouldBuy: {
    ...
    subtitle:
      'A higher member count can make your Telegram group or channel look more active and reliable at first glance. TrendEvo helps Bangladeshi businesses, creators, agencies, and community owners grow their Telegram presence through a trusted lnk<SMM Panel BD|/> with simple ordering, local payment support, and smooth delivery.',
    titleClassName:
