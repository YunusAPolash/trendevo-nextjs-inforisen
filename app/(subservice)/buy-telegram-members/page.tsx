...
import TelegramMembersCtaSection from '@/app/(subservice)/buy-telegram-members/_components/cta-section';
import TelegramMembersHeroSection from '@/app/(subservice)/buy-telegram-members/_components/hero-section';
import TelegramMembersOrderFormSection from '@/app/(subservice)/buy-telegram-members/_components/order-form-section';
import TelegramMembersWorkingProcessSection from '@/app/(subservice)/buy-telegram-members/_components/working-process-section';
