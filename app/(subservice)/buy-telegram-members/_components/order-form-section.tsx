...
const TITLE_TELEGRAM_ICON_SIZE = 29;
const FORM_TELEGRAM_ICON_SIZE = 20;
...
function TelegramIcon({
  ...
  const size = variant === 'title' ? TITLE_TELEGRAM_ICON_SIZE : FORM_TELEGRAM_ICON_SIZE;
...
export default function TelegramMembersOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://t.me/yourchannel');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <TelegramIcon variant="title" alt="Telegram" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="Telegram Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
