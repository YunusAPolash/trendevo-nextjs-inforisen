...
const TITLE_SOUNDCLOUD_ICON_SIZE = 29;
const FORM_SOUNDCLOUD_ICON_SIZE = 20;
...
function SoundCloudIcon({
  ...
  const size = variant === 'title' ? TITLE_SOUNDCLOUD_ICON_SIZE : FORM_SOUNDCLOUD_ICON_SIZE;
...
export default function SoundcloudPlaysOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://soundcloud.com/artist/track');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <SoundCloudIcon variant="title" alt="SoundCloud" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="SoundCloud Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
