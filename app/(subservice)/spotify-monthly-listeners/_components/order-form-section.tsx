...
const TITLE_SPOTIFY_ICON_SIZE = 29;
const FORM_SPOTIFY_ICON_SIZE = 20;
...
function SpotifyIcon({
  ...
  const size = variant === 'title' ? TITLE_SPOTIFY_ICON_SIZE : FORM_SPOTIFY_ICON_SIZE;
      ...
      >
        ...
        >
          ...
          <input
            ...
            aria-label="Monthly listener quantity"
...
export default function SpotifyMonthlyListenersOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://open.spotify.com/artist/yourartistid');
              ...
              <FormField label="Spotify Post URL">
                <FieldShell>
                  <input
                    ...
                    placeholder="https://open.spotify.com/artist/yourartistid"
