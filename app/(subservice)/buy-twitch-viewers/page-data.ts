...
type TwitchViewersPageData = {
  ...
  serviceLeadingSlugs: ['twitch-viewers', 'twitch-viewers-related-services'];
...
export const data: TwitchViewersPageData = {
  seo: {
    title: 'Buy Twitch Viewers | TrendEvo',
    description:
      'Buy real Twitch viewers at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/buy-twitch-viewers',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Twitch Viewers> in Real, Fast & Affordable price.',
    description:
      'Growing a Twitch channel can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your streams thrive with real viewers and engagement.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      src: '/images/subservice/buy-twitch-viewers/buy-twitch-viewers-in-real-fast-and-affordable-price.webp',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Twitch Viewers gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Twitch Viewers Service',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Twitch viewers, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Twitch viewers can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Twitch password — only your public channel URL is required to deliver viewers',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver viewers gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your channel.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Twitch viewers delivery progresses.',
      },
      {
