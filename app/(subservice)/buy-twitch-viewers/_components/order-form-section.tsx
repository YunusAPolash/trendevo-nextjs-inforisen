...
const TWITCH_ICON =
  '/images/our-services/platforms/discord-platform-icon.webp';
const TITLE_TWITCH_ICON_SIZE = 29;
const FORM_TWITCH_ICON_SIZE = 20;
...
function TwitchIcon({
  ...
  const size = variant === 'title' ? TITLE_TWITCH_ICON_SIZE : FORM_TWITCH_ICON_SIZE;
...
export default function TwitchViewersOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://twitch.tv/yourchannel');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <TwitchIcon variant="title" alt="Twitch" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="Twitch Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
