...
const TITLE_INSTAGRAM_ICON_SIZE = 29;
const FORM_INSTAGRAM_ICON_SIZE = 20;
...
function InstagramIcon({
  ...
  const size = variant === 'title' ? TITLE_INSTAGRAM_ICON_SIZE : FORM_INSTAGRAM_ICON_SIZE;
      ...
      >
        ...
        >
          ...
          <input
            ...
            aria-label="Story view quantity"
...
export default function InstagramStoryViewsOrderFormSection() {
  const [storyOrProfileUrl, setStoryOrProfileUrl] = useState(orderForm.urlPlaceholder);
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label={orderForm.urlFieldLabel}>
                <FieldShell>
                  <input
                    type="url"
                    value={storyOrProfileUrl}
                    onChange={(event) => setStoryOrProfileUrl(event.target.value)}
