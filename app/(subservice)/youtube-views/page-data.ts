...
type YoutubeViewsPageData = {
  ...
  serviceLeadingSlugs: ['youtube-views', 'youtube-views-related-services'];
...
export const data: YoutubeViewsPageData = {
  seo: {
    title: 'Buy YouTube Views | TrendEvo',
    description:
      'Buy real YouTube views at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/youtube-views',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<YouTube Views> in Real, Fast & Affordable price.',
    description:
      'Growing a YouTube channel can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your channel thrive with real views and watch-time growth.',
    signInLabel: 'Sign In',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy YouTube Views gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the YouTube Views Service',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as YouTube views, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your YouTube views can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your YouTube password — only your public video URL is required to deliver views.',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver views gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your channel.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your YouTube views delivery progresses.',
      },
      {
