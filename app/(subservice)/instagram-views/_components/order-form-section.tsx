...
export default function InstagramViewsOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://instagram.com/p/yourpost');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="Instagram Post/Reel URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
