...
type TelegramMembersPageData = {
  ...
  serviceLeadingSlugs: ['telegram-members', 'telegram-members-related-services'];
...
export const data: TelegramMembersPageData = {
  seo: {
    title: 'Buy Telegram Members | TrendEvo',
    description:
      'Buy real Telegram members at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/telegram-members',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Telegram Members> in Real, Fast & Affordable price.',
    description:
      'Growing a Telegram channel can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your channel thrive with real members and engagement.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      ...
      alt: 'Excited user celebrating Telegram growth with analytics chart',
      width: 558,
      height: 621,
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Telegram Members gt<on TrendEvo>',
    subtitle:
      'A Telegram SMM panel helps businesses grow followers, likes, and engagement quickly and efficiently, saving time and boosting online presence.',
    titleClassName:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Telegram Members Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your Telegram Channel URL & Place the Order',
        description:
  ...
  testimonials: {
    ...
    badge: 'TESTIMONIALS',
    title: 'Telegram Panel gt<Reviews>',
    subtitle:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Telegram members, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Telegram members can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Telegram password — only your public channel URL is required to deliver members',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver members gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your channel.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Telegram members delivery progresses.',
      },
      {
