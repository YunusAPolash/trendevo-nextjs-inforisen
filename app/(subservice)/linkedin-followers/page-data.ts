...
type LinkedinFollowersPageData = {
  ...
  serviceLeadingSlugs: ['linkedin-followers', 'linkedin-followers-related-services'];
...
export const data: LinkedinFollowersPageData = {
  seo: {
    title: 'Buy LinkedIn Followers | TrendEvo',
    description:
      'Buy real LinkedIn followers at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/linkedin-followers',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<LinkedIn Followers> in Real, Fast & Affordable price.',
    description:
      'Growing a LinkedIn profile can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your profile thrive with real followers and professional growth.',
    signInLabel: 'Sign In',
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy LinkedIn Followers gt<on TrendEvo>',
    subtitle:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the LinkedIn Followers Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your LinkedIn Profile URL & Place the Order',
        description:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as LinkedIn followers, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your LinkedIn followers can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your LinkedIn password — only your public profile URL is required to deliver followers.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your LinkedIn followers delivery progresses.',
      },
      {
