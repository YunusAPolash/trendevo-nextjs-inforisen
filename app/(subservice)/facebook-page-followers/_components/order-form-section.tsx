          ...
          <div className="relative z-10 flex flex-col gap-[30px]">
            <div className="flex w-full flex-col items-center gap-4 text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-[8px]">
                <h2 className="text-[32px] font-semibold leading-none text-[#1a1a1a] dark:text-[#f5f6f7]">
                  Order Facebook
                </h2>
                <span
                ...
                <h2 className="text-gradient text-[32px] font-semibold leading-none dark:from-[#9f00ff] dark:to-[#ff3fa2]">
                  Followers
                </h2>
              </div>
            </div>
