...
const TITLE_SNAPCHAT_ICON_SIZE = 29;
const FORM_SNAPCHAT_ICON_SIZE = 20;
...
function SnapchatIcon({
  ...
  const size = variant === 'title' ? TITLE_SNAPCHAT_ICON_SIZE : FORM_SNAPCHAT_ICON_SIZE;
...
export default function SnapchatFollowersOrderFormSection() {
  const [targetUrl, setTargetUrl] = useState('https://snapchat.com/add/yourprofile');
        ...
        >
          <div className="relative z-10 flex flex-col gap-[30px]">
              ...
              title={
                <span className="flex flex-wrap items-center justify-center gap-[8px]">
                  ...
                  <span
                    ...
                    aria-hidden
                  >
                    <SnapchatIcon variant="title" alt="Snapchat" />
                  </span>
            ...
            <div className="relative z-10 flex w-full min-w-0 flex-col gap-6 overflow-visible">
              ...
              <FormField label="Snapchat Post URL">
                <FieldShell>
                  <input
                    type="url"
                    value={targetUrl}
