...
type DiscordMembersPageData = {
  ...
  serviceLeadingSlugs: ['discord-members', 'discord-members-related-services'];
...
export const data: DiscordMembersPageData = {
  seo: {
    title: 'Buy Discord Members | TrendEvo',
    description:
      'Buy real Discord members at affordable prices. Fast delivery, secure checkout, and 24/7 support from TrendEvo in Bangladesh.',
    canonical: '/buy-discord-members',
  },

  hero: {
    bg: 'section-1',
    variant: 'wide',
    title: 'Buy gt<Discord Members> in Real, Fast & Affordable price.',
    description:
      'Growing a Discord server can be tough. Consistent content and smart promotion are key, but results can be slow. At TrendEvo, we provide solutions to help your server thrive with real members and engagement.',
    signInLabel: 'Sign In',
    ...
    illustration: {
      src: '/images/subservice/buy-discord-members/buy-discord-members-in-real-fast-and-affordable-price.webp',
      alt: 'Excited user celebrating Discord growth with analytics chart',
      width: 558,
      height: 621,
  ...
  workingProcess: {
    ...
    underlineWidth: 216,
    title: 'How to Buy Discord Members gt<on TrendEvo>',
    subtitle:
      'A Discord SMM panel helps businesses grow followers, likes, and engagement quickly and efficiently, saving time and boosting online presence.',
    titleClassName:
    ...
    steps: [
      ...
      {
        number: '03',
        title: 'Find the Discord Members Service',
        description:
          'Make payments safely via trusted methods to protect your information.',
      },
      {
        number: '04',
        title: 'Enter Your Discord Server Invite URL & Place the Order',
        description:
  ...
  testimonials: {
    ...
    badge: 'TESTIMONIALS',
    title: 'Discord Panel gt<Reviews>',
    subtitle:
    ...
    items: [
      {
        ...
        answer:
          'An SMM panel is an online platform where you can buy social media marketing services such as Discord members, followers, and engagement. TrendEvo lets you place orders, track delivery, and manage your growth from one dashboard.',
      },
      {
        question: 'Can the SMM Panel target a specific group?',
        answer:
          'Yes. Depending on the service you choose, TrendEvo offers targeting options so your Discord members can align with your preferred audience type, region, or niche when available for that package.',
      },
      {
        question: 'Is Using an SMM Panel Safe?',
        answer:
          'TrendEvo uses secure checkout, encrypted payments, and privacy-focused order handling. We never ask for your Discord password — only your public server invite URL is required to deliver members',
      },
      {
        question: 'Does using an SMM Panel risk banning my account?',
        answer:
          'We deliver members gradually using methods designed to look natural. While no service can guarantee zero platform risk, TrendEvo focuses on quality delivery and safe pacing to help protect your server.',
      },
      {
        question: 'Can I track the progress of my orders?',
        answer:
          'Yes. After placing an order, you can monitor its status in real time from your TrendEvo dashboard and see updates as your Discord members delivery progresses.',
      },
      {
