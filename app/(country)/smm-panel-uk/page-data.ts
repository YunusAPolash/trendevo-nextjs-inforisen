...
const smmPanelUkFaqItems = [
  ...
  {
    question: 'Can I place bulk orders for UK social media growth?',
    answer:
      'Yes. TrendEvo supports bulk and repeat orders for UK agencies, resellers, and businesses that need consistent social media growth at scale.',
  },
  {
    question: 'How do I place an SMM order on TrendEvo from the UK?',
    answer:
...
export const data: SmmPanelUkPageData = {
  seo: {
  ...
  faq: {
    label: 'FAQ',
    title: 'Frequently Asked gt<Questions> for UK',
    subtitle:
  ...
  cta: {
    title:
      'Ready to gt<Grow Your Social Media in the UK> with TrendEvo',
    description:
    ...
    imageAlt:
      'Start growing your social media presence in the UK with TrendEvo',
  },
};
