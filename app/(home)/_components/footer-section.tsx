...
const serviceLinks = [
  ...
  { label: 'Facebook Page Likes', href: '/facebook-page-likes' },
  { label: 'Facebook Page Comments', href: '/facebook-page-comments' },
  ...
  { label: 'YouTube Comments', href: '/youtube-comments' },
  { label: 'YouTube Likes', href: '/youtube-likes' },
  ...
  { label: 'Instagram Shares', href: '/instagram-shares' },
  { label: 'Instagram Auto-Likes', href: '/instagram-auto-likes' },
  { label: 'Instagram Story Views', href: '/instagram-story-views' },
  { label: 'X-Twitter Services', href: '/x-twitter-smm-panel' },
  { label: 'Twitter Followers', href: '/twitter-followers' },
  { label: 'Twitter Likes', href: '/twitter-likes' },
  { label: 'Telegram Services', href: '/telegram-smm-panel' },
  { label: 'Telegram Members', href: '/telegram-members' },
  { label: 'TikTok Services', href: '/tiktok-smm-panel' },
  { label: 'TikTok Followers', href: '/tiktok-followers' },
  { label: 'TikTok Likes', href: '/tiktok-likes' },
  { label: 'TikTok Views', href: '/tiktok-views' },
  { label: 'LinkedIn Followers', href: '/linkedin-followers' },
  { label: 'LinkedIn Likes', href: '/linkedin-likes' },
  { label: 'Spotify Services', href: '/spotify-smm-panel' },
  { label: 'Spotify Plays', href: '/spotify-plays' },
  { label: 'Spotify Followers', href: '/spotify-followers' },
  { label: 'Spotify Monthly Listeners', href: '/spotify-monthly-listeners' },
  { label: 'Soundcloud Services', href: '/soundcloud-smm-panel' },
  { label: 'SoundCloud Followers', href: '/soundcloud-followers' },
  { label: 'SoundCloud Plays', href: '/soundcloud-plays' },
  { label: 'Twitch Services', href: '/twitch-smm-panel' },
  { label: 'Twitch Followers', href: '/twitch-followers' },
  { label: 'Twitch Viewers', href: '/twitch-viewers' },
  { label: 'Kick Followers', href: '/kick-followers' },
  { label: 'Kick Viewers', href: '/kick-viewers' },
  { label: 'Reddit Upvotes', href: '/reddit-upvotes' },
  { label: 'Reddit Account', href: '/reddit-account' },
  { label: 'Quora Followers', href: '/quora-followers' },
  { label: 'Quora Upvotes', href: '/quora-upvotes' },
  { label: 'Vimeo Followers', href: '/vimeo-followers' },
  { label: 'Threads Followers', href: '/threads-followers' },
  { label: 'Snapchat Services', href: '/snapchat-smm-panel' },
  { label: 'Snapchat Followers', href: '/snapchat-followers' },
  { label: 'Discord Members', href: '/discord-members' },
  { label: 'Discord Account', href: '/discord-account' },
];
