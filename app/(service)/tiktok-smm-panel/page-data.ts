...
export const data: TiktokSmmPanelPageData = {
  ...
  socialServices: {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          'Increase views on your TikTok videos, product clips, tutorials, reviews, trends, challenges, and promotional content. More lnk<tiktok views|/buy-tiktok-views> help your videos look active and worth watching.',
      ...
      },
      {
        ...
        description:
          'Grow multiple engagement signals together with followers, views, likes, comments, shares, live views, and profile activity. These packages help agencies, lnk<resellers|https://trendevo.com/api>, creators, and businesses manage balanced TikTok growth more easily.',
  ...
  advantages: {
    ...
    subtitle:
      'A reliable TikTok lnk<SMM Panel service|/services> helps creators, influencers, businesses, and agencies grow their TikTok presence with less manual effort. TrendEvo makes it easier to improve profile trust, video activity, live visibility, content reach, and campaign engagement from one simple dashboard.',
    titleClassName:
