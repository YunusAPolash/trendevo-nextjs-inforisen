...
export const data: SpotifySmmPanelPageData = {
    ...
    services: [
      {
        title: 'Spotify Plays',
        description:
          'Give your tracks more listening activity with Spotify plays. This service is useful for singles, albums, EPs, remixes, cover songs, lo-fi tracks, nasheeds, podcasts, and independent releases that need stronger early traction.',
      ...
      },
      {
        ...
        description:
          'Build long-term audience value for your artist profile. More Spotify followers can help your profile look more established when new listeners, playlist curators, music fans, or potential collaborators check your work.',
      ...
      },
      {
        ...
        description:
          'Improve your artist profile activity with Spotify monthly listeners. This helps artists show that their music is reaching active listeners during release campaigns, promotions, and profile-building stages.',
  ...
  advantages: {
    ...
    subtitle:
      'Spotify growth is not only about uploading a song. Artists need listeners, repeat plays, saved tracks, profile activity, and release momentum. A Spotify SMM Panel helps Bangladeshi musicians, labels, agencies, and resellers support those signals without managing every promotion step manually.',
    titleClassName:
