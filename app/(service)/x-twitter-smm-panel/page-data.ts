...
export const data: XTwitterSmmPanelPageData = {
  ...
  hero: {
    ...
    descriptionSecondary:
      'Strengthen your X (Twitter) presence with affordable pricing, bKash, Nagad, Rocket payment support, and services made for brand promotion, creator growth, public reach, and social media visibility in Bangladesh.',
  ...
  socialServices: {
    ...
    subtitle:
      'TrendEvo brings all major X (Twitter) growth services into one simple dashboard for Bangladeshi businesses, creators, agencies, professionals, startup teams, and resellers. Whether you want more profile trust, post engagement, tweet visibility, campaign reach, or brand authority, our X (Twitter) SMM Panel BD services help you manage growth faster and more affordably.',
    titleClassName:
    ...
    services: [
      {
        ...
        description:
          'Build a stronger audience base for your X (Twitter) followers. This service is useful for founders, creators, agencies, journalists, influencers, local brands, and businesses that want their profile to look active and trustworthy.',
      ...
      },
      {
        ...
        description:
          'Improve your post engagement with more X (Twitter) likes. Likes help your tweets, updates, opinions, campaign posts, and brand messages look more interesting when new users see them.',
  ...
  advantages: {
    ...
    rightAdvantages: [
      ...
      },
      {
        ...
        description:
          'Our X (Twitter) SMM Panel services are suitable for personal brands, startup founders, agencies, local businesses, influencers, public figures, news pages, and reseller clients. You can manage different growth needs in one place.',
