...
export const data: TelegramSmmPanelPageData = {
  ...
  advantages: {
    ...
    subtitle:
      'A reliable Telegram SMM Panel helps businesses, creators, agencies, and community owners grow their Telegram presence with less manual effort. lnk<TrendEvo|/about-us> makes it easier to improve channel trust, group activity, post visibility, audience engagement, and campaign support from one simple dashboard.',
    titleClassName:
  ...
  workingProcess: {
    ...
    subtitle:
      'TrendEvo makes Telegram growth simple for Bangladeshi users. You can choose a service, place your order, lnk<pay with local methods|https://trendevo.com/signup>, and track everything from one easy dashboard.',
    titleClassName:
      'max-w-[1200px] whitespace-normal text-2xl tracking-[0.48px] sm:text-[32px] md:text-[40px] lg:text-[48px]',
    subtitleClassName: 'max-w-[1064px] text-base sm:text-lg',
    steps: [
      {
        ...
        description:
          'lnk<Sign up|https://trendevo.com/signup> on TrendEvo and access your Telegram SMM Panel dashboard. The process is simple, quick, and made for businesses, creators, agencies, community owners, and resellers in Bangladesh.',
      },
      {
        number: '02',
