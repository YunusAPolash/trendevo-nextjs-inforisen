...
export const data: YoutubeSmmPanelPageData = {
  ...
  socialServices: {
    ...
    subtitle:
      'TrendEvo brings all major YouTube growth services into one simple dashboard for Bangladeshi creators, businesses, agencies, musicians, influencers, and resellers. Whether you want more channel trust, video reach, audience engagement, Shorts visibility, or monetization support, our YouTube SMM Panel in Bangladesh services help you manage growth faster and more affordably.',
    titleClassName:
    ...
    services: [
      {
        ...
        description:
          'Build a stronger audience base for your YouTube channel by using our youtube subscribers service. This service is useful for creators, educators, vloggers, businesses, musicians, and startups that want their channel to look active and trustworthy.',
      ...
      },
      {
        ...
        description:
          'Increase views on your YouTube videos, product reviews, tutorials, music videos, podcasts, and promotional content. More youtube views help your videos look active and worth watching.',
      ...
      },
      {
        title: 'YouTube Likes',
        description:
          'Improve your video engagement with more YouTube likes. Likes help videos look more valuable and can support better viewer trust when people discover your content.',
      ...
      },
      {
        ...
        description:
          'Create stronger conversations around your videos with YouTube comments. This works well for reviews, tutorials, product videos, music releases, educational content, and brand campaigns.',
  ...
  leading: {
    ...
    subtitle:
      'TrendEvo helps Bangladeshi creators, businesses, agencies, musicians, influencers, and resellers manage YouTube growth with speed, safety, and better control. Our platform combines local payment support, affordable pricing, smooth order tracking, and reliable YouTube SMM services in one simple dashboard.',
    titleClassName:
