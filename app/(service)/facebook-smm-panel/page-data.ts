...
export const data: FacebookSmmPanelPageData = {
  ...
  hero: {
    ...
    description:
      'TrendEvo helps Bangladeshi businesses, creators, agencies, and resellers build a stronger Facebook presence with reliable followers, page likes, post engagement, comments, shares, and video views. Our Facebook SMM Panel makes every order simple, secure, and easy to track from one clean dashboard.',
  ...
  socialServices: {
    ...
    subtitle:
      'TrendEvo brings all major Facebook growth services into one simple dashboard for Bangladeshi businesses, creators, agencies, and resellers. Whether you want more page trust, post engagement, video reach, group activity, or campaign support, our facebook SMM panel BD services help you manage growth faster and more affordably.',
    titleClassName:
    ...
    services: [
      {
        ...
        description:
          'Build a stronger audience base for your Facebook business page. Facebook page followers are useful for ecommerce shops, local brands, service providers, and startups that want their page to look active and trustworthy.',
      ...
      },
      {
        ...
        description:
          'Improve your page’s first impression with more Facebook page likes. This helps Bangladeshi businesses build trust when customers visit their page, check reviews, or contact through Messenger.',
      ...
      },
      {
        ...
        description:
          'Create stronger conversations around your content with Facebook comments. This works well for promotional posts, product launches, polls, reviews, and community campaigns.',
        icon: '/images/service-smm-panel/facebook-smm-panel-facebook-post-react-icon.png',
        iconWidth: 54,
        iconHeight: 54,
      },
  ...
  leading: {
    ...
    subtitle:
      'TrendEvo helps Bangladeshi businesses, creators, agencies, and resellers manage Facebook growth with speed, safety, and better control. Our platform combines local payment support, affordable pricing, smooth order tracking, and reliable Facebook SMM services in one simple dashboard.',
    titleClassName:
